...
import type StCheckbox from './checkbox.js';

describe('<st-checkbox>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox>Checkbox</st-checkbox> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox></st-checkbox> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox title="Test"></st-checkbox> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox disabled></st-checkbox> `);
  ...
  it('should emit st-change and st-input when clicked', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox></st-checkbox> `);
  ...
  it('should emit st-change and st-input when toggled with spacebar', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox></st-checkbox> `);
    const changeHandler = sinon.spy();
    const inputHandler = sinon.spy();
  ...
  it('should not emit st-change or st-input when checked programmatically', async () => {
    const el = await fixture<StCheckbox>(html` <st-checkbox></st-checkbox> `);
  ...
  describe('when submitting a form', () => {
    it('should submit the correct value when a value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <st-checkbox name="a" value="1" checked></st-checkbox>
    ...
    it('should submit "on" when no value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <st-checkbox name="a" checked></st-checkbox>
          <st-button type="submit">Submit</st-button>
        </form>
      `);
      const button = form.querySelector('st-button')!;
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <st-checkbox></st-checkbox> `);
    ...
    it('should be invalid when required and unchecked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <st-checkbox required></st-checkbox> `);
      expect(checkbox.checkValidity()).to.be.false;
    });

    it('should be valid when required and checked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <st-checkbox required checked></st-checkbox> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <st-checkbox form="f" name="a" value="1" checked></st-checkbox>
        </div>
      `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><st-checkbox required></st-checkbox></form> `);
      const checkbox = el.querySelector<StCheckbox>('st-checkbox')!;
  ...
  describe('focus', () => {
    ...
    it('should not jump the page to the bottom when focusing a checkbox at the bottom of an element with overflow: auto;', async () => {
      ...
      const checkboxes = el.querySelectorAll<StCheckbox>('st-checkbox');
  ...
  describe('indeterminate', () => {
    it('should render indeterminate icon until checked', async () => {
      const el = await fixture<StCheckbox>(html`<st-checkbox indeterminate></st-checkbox>`);
    ...
    runFormControlBaseTests('st-checkbox');
  });
});
