 ...
 */
export default class StMenuItem extends ShoelaceElement {
    ...
    return html`
      ...
      >
        ...
        <span part="submenu-icon" class="menu-item__chevron">
          <st-icon name=${isRtl ? 'chevron-left' : 'chevron-right'} library="system" aria-hidden="true"></st-icon>
        </span>

        ${this.submenuController.renderSubmenu()}
        ${this.loading ? html` <st-spinner part="spinner" exportparts="base:spinner__base"></st-spinner> ` : ''}
      </div>
    `;
  }
}
