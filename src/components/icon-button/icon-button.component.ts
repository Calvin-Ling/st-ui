 ...
 * @dependency st-icon
 *
 * @event st-blur - Emitted when the icon button loses focus.
 * @event st-focus - Emitted when the icon button gains focus.
 *
 * @csspart base - The component's base wrapper.
 */
export default class StIconButton extends ShoelaceElement {
