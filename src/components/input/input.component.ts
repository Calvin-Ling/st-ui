 ...
 *
 * @event st-blur - Emitted when the control loses focus.
 * @event st-change - Emitted when an alteration to the control's value is committed by the user.
 * @event st-clear - Emitted when the clear button is activated.
 * @event st-focus - Emitted when the control gains focus.
 * @event st-input - Emitted when the control receives input.
 ...
 */
export default class StInput extends ShoelaceElement implements ShoelaceFormControl {
  static styles: CSSResultGroup = [componentStyles, formControlStyles, styles];
  static dependencies = { 'st-icon': StIcon };

  private readonly formControlController = new FormControlController(this, {
    assumeInteractionOn: ['st-blur', 'st-input']
  });
        ...
        ? html`
                  ...
                  >
                    <slot name="clear-icon">
                      <st-icon name="x-circle-fill" library="system"></st-icon>
                    </slot>
                  </button>
                `
        : ''}
        ...
        ? html`
            ...
            ? html`
                          <slot name="show-password-icon">
                            <st-icon name="eye-slash" library="system"></st-icon>
                          </slot>
                        `
            : html`
