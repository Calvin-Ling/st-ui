 ...
 *
 * @event {{ entries: ResizeObserverEntry[] }} st-resize - Emitted when the element is resized.
 */
export default class StResizeObserver extends ShoelaceElement {
  ...
  connectedCallback() {
    ...
    this.resizeObserver = new ResizeObserver((entries: ResizeObserverEntry[]) => {
      this.emit('st-resize', { detail: { entries } });
    });
