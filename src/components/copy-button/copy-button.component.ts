...
import StTooltip from '../tooltip/tooltip.component.js';
 ...
 *
 * @dependency st-icon
 * @dependency st-tooltip
 *
 * @event st-copy - Emitted when the data has been copied.
 * @event st-error - Emitted when the data could not be copied.
 *
 * @slot copy-icon - The icon to show in the default copy state. Works best with `<st-icon>`.
 * @slot success-icon - The icon to show when the content is copied. Works best with `<st-icon>`.
 * @slot error-icon - The icon to show when a copy error occurs. Works best with `<st-icon>`.
 *
 ...
 */
export default class StCopyButton extends ShoelaceElement {
  ...
  @query('st-tooltip') tooltip: StTooltip;
      ...
      >
        ...
        >
          <slot part="copy-icon" name="copy-icon">
            <st-icon library="system" name="copy"></st-icon>
          </slot>
          <slot part="success-icon" name="success-icon" hidden>
            <st-icon library="system" name="check"></st-icon>
          </slot>
          <slot part="error-icon" name="error-icon" hidden>
            <st-icon library="system" name="x-lg"></st-icon>
          </slot>
        </button>
      </st-tooltip>
    `;
