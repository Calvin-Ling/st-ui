 ...
 * @since 2.0
 *
 * @event st-cancel - Emitted when the animation is canceled.
 * @event st-finish - Emitted when the animation finishes.
 * @event st-start - Emitted when the animation starts or restarts.
 *
 * @slot - The element to animate. Avoid slotting in more than one element, as subsequent ones will be ignored. To
 *  animate multiple elements, either wrap them in a single container or use multiple `<st-animation>` elements.
 */
export default class StAnimation extends ShoelaceElement {
