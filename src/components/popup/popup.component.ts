 ...
 * @since 2.0
 *
 * @event st-reposition - Emitted when the popup is repositioned. This event can fire a lot, so avoid putting expensive
 ...
 *  attribute is used.
 * @cssproperty [--arrow-color=var(--st-color-neutral-0)] - The color of the arrow.
 ...
 *  available when using `auto-size`.
 */
export default class StPopup extends ShoelaceElement {
