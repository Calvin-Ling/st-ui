...
/** Used by st-split-panel to convert an input position into a snapped position. */
 ...
 * @since 2.0
 *
 * @event st-reposition - Emitted when the divider's position changes.
 *
 ...
 */
export default class StSplitPanel extends ShoelaceElement {
